...
- **Gamification**: difficulty-weighted points, an in-quiz streak, a
...
- **Accessibility**: WCAG 2.2 AA targets, including visible focus states,
  44px touch targets, keyboard-operable hotspots, ARIA labels,
  `prefers-reduced-motion`, and never relying on colour alone.

## Run it
Open `index.html` in a browser. (When served over HTTP (for example GitHub Pages or
